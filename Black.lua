...
local var = true
local url , res = https.request('https://teamstorm.tk/joinb/?id='..msg.sender_user_id_..'')
...
os.execute('wget https://raw.githubusercontent.com/SourceBlack/Black/master/Black.lua')
...
usertext = '\n👤| العضو » ['..result.title_..'](t.me/'..(username or 'DEVBLACK')..')'
...
usertext = '\n👤| العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVBLACK')..')'
status  = '\n📫| تم ترقيته مطور في البوت'
...
send(msg.chat_id_,0,"⚠|العضو : {["..data.first_name_.."](T.ME/DEVBLACK)}\n📛|["..Black_Msg.."] \n") 
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
📄| [قناة الشروحات](t.me/XI_Xl)

📥| [قناه السورس](http://t.me/devblack)
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'👤| بواسطه ← ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'DEVBLACK')..') \n🔐| تـم قفـل الدردشه ')  
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'👤| بواسطه ← ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'DEVBLACK')..') \n🔐| تـم قفـل التاك بالكتم ')  
end,nil)   
...
t = "\n⛔| قائمة المنع \n━━━━━━━━━━━━━\n"
for k,v in pairs(list) do  
local Black_Msg = database:get(bot_id.."Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..''..k..'- '..v..' » {'..Black_Msg..'}\n'    
end  
if #list == 0 then  
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n👤| العضو » ['..result.title_..'](t.me/'..(text1[3] or 'DEVBLACK')..')'..'\n📬| تم رفعه '..text1[2]..' هنا')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
